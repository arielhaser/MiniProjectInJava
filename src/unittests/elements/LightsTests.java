...
public class LightsTests {
    ...
    public void trianglesFull() {
        ...
        scene.addLights(new SpotLight(new Color(500, 250, 250),
                new Point3D(10, 10, 130), new Vector(-2, 2, 1),
                1, 0.0001, 0.000005),
                new PointLight(new Color(500, 250, 250),
                        new Point3D(0, 100, 0),
                        1, 0.0005, 0.0005),
                new DirectionalLight(new Color(300, 150, 150), new Vector(0, 0, 1)));

        ImageWriter imageWriter = new ImageWriter("trianglesFull", 200, 200, 500, 500);
        Render render = new Render(imageWriter, scene);
    ...
    public void sphereFull() {
        ...
        scene.addLights(new SpotLight(new Color(500, 300, 0), new Point3D(-50, 50, -50),
                new Vector(1, -1, 2), 1, 0.00001, 0.00000001),
                new PointLight(new Color(500, 300, 0), new Point3D(50, 50, 0), 1, 0.00001, 0.000001),
                new DirectionalLight(new Color(500, 300, 0), new Vector(-1, 1, -1)));

        ImageWriter imageWriter = new ImageWriter("sphereFull", 150, 150, 500, 500);
        Render render = new Render(imageWriter, scene);
